        ...
        <Avatar className="mt-0.5 h-8 w-8 shrink-0 select-none">
          <div className="relative h-8 w-8">
            <svg 
              ...
              viewBox="0 0 100 100"
              className="h-full w-full rounded-full ring-2 ring-offset-2 ring-offset-background ring-blue-500/20"
            >
              <defs>
                <linearGradient id="avatarGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: '#00ff9d' }}/>
                  <stop offset="100%" style={{ stopColor: '#00b8ff' }}/>
                </linearGradient>
              </defs>
              <circle 
                cx="50" 
              ...
              />
              <path 
                d="M65 35H35v6h30v-6zm0 12H35v6h30v-6zm0 12H35v6h30v-6z" 
                fill="#000"
      ...
      <Avatar className="mt-0.5 h-8 w-8 shrink-0 select-none">
        <div className="relative h-8 w-8">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 100 100"
            className="h-full w-full animate-pulse rounded-full ring-2 ring-offset-2 ring-offset-background ring-blue-500/20"
          >
            <defs>
              <linearGradient 
                id="loadingAvatarGradient" 
                x1="0%" 
                y1="0%" 
                x2="100%" 
                y2="100%"
            ...
            <circle 
              ...
              cy="50" 
              r="48" 
              fill="url(#loadingAvatarGradient)"
              className="drop-shadow-md"
            />
            <path 
              d="M65 35H35v6h30v-6zm0 12H35v6h30v-6zm0 12H35v6h30v-6z" 
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="no-scrollbar relative flex-1 overflow-y-auto">
        <div className="mx-auto w-full max-w-3xl px-4 md:ml-4">
          <div className="space-y-4 pb-36 pt-4">
      ...
      <div className="sticky bottom-0 z-10">
        <div className="relative mx-auto w-full max-w-3xl px-4 py-4 md:ml-4">
          {/* Floating Wallet */}
          {portfolio && (
            ...
            >
              <div className="relative flex items-start p-4">
                <textarea
                  ...
                  rows={3}
                  className={cn(
                    'min-h-[90px] w-full resize-none bg-transparent pr-12',
